    ...
    render() {
        ...
        return (
            <div className="playlist sun-wrapper">
                ...
                {
                    coverImgUrl && <div className="sun-blur sun-blur-min">
                        <div className="sun-blur-bg" style={{backgroundImage: `url(${coverImgUrl}?param=100y100)`}}/>
                        </div>
               }
               {
                   loading ? <Loading/> : <Scroll className="sun-content">
                        <header className="playlist-header">
                            <div className="sun-blur">
                                <div className="sun-blur-bg" style={{backgroundImage: `url(${coverImgUrl}?param=100y100)`}}/>
                            </div>
